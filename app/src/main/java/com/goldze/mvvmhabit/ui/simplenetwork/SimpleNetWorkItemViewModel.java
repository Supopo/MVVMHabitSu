...
public class SimpleNetWorkItemViewModel extends ItemViewModel<SimpleNetWorkViewModel> {
    public ObservableField<DemoEntity.ItemsEntity> entity = new ObservableField<>();
    public Drawable drawableImg;

    public SimpleNetWorkItemViewModel(@NonNull SimpleNetWorkViewModel viewModel, DemoEntity.ItemsEntity entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            if (entity.get().getId() == -1) {
                viewModel.deleteItemLiveData.setValue(SimpleNetWorkItemViewModel.this);
            } else {
                //跳转到详情界面,传入条目的实体对象
